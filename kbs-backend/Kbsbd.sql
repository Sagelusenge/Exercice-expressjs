...
-- Date    : 2024
-- ============================================================
CREATE DATABASE IF NOT EXISTS KBSw;
USE KBSw;
...
-- ============================================================
UPDATE users SET 
  mot_de_passe = '$2a$12$R9h/7shzW.Y1.B72K6pYke.j8A9X6uU2j6.y6.y6.y6.y6.y6.y6.', 
  email_verifie = 1, 
  statut = 'ACTIF' 
...
(1, 'RESERVATION_ACTIVE',            'true',  'BOOLEAN', 'Activer/désactiver les réservations en ligne'),
