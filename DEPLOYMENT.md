...
3. Importe le schema:
   ...
   - Importe `Kbsbd-clever-final.sql`.
   - Ce fichier est adapte a Clever Cloud: il ne contient pas `CREATE DATABASE`, pas `USE ...`, pas d'events MySQL, et pas de fonction MySQL bloquee par le privilege `SUPER`.
