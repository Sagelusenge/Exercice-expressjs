...
-- Expiration des rÃ©servations â€” toutes les heures
...
-- VÃ©rification retards loyer â€” chaque jour Ã  08h00
...
-- Rappel Ã©chÃ©ance J-7 â€” chaque jour Ã  09h00
...
-- ParamÃ¨tres systÃ¨me initiaux
INSERT INTO parametres_systeme (tenant_id, cle, valeur, type_valeur, description) VALUES
(1, 'RESERVATION_ACTIVE',            'true',  'BOOLEAN', 'Activer/dÃ©sactiver les rÃ©servations en ligne'),
(1, 'DUREE_RESERVATION_JOURS',       '7',     'INTEGER', 'DurÃ©e de validitÃ© d''une rÃ©servation en jours'),
(1, 'EMAIL_ADMIN_PRINCIPAL',         'contact@kbs-immobilier.com', 'STRING', 'Email principal admin'),
(1, 'DELAI_RAPPEL_ECHEANCE_JOURS',   '7',     'INTEGER', 'Jours avant Ã©chÃ©ance pour rappel'),
(1, 'DEVISE_PRINCIPALE',             'USD',   'STRING',  'Devise par dÃ©faut du systÃ¨me'),
...
(1, 'DUREE_BLOCAGE_MINUTES',         '30',    'INTEGER', 'DurÃ©e de blocage compte en minutes');

-- Initialisation sÃ©quences pour tables sans tenant spÃ©cifique
INSERT INTO sequences_references (table_cible, tenant_id, prefix, derniere_valeur)
VALUES ('tenants', 0, 'KBS-ORG-', 0);

-- Super Admin initial KBS
-- (Le trigger gÃ©nÃ©rera le code_user automatiquement)
INSERT INTO users (
    tenant_id,
    nom,
    prenom,
    ...
    '+243000000001',
    -- Mot de passe de test: KbsAdmin@2026
...
(1, 'EMAIL_CODE_VERIFICATION', 'PARCELLES',
 'VÃ©rification de votre compte KBS â€” Code {{code}}',
 'Votre code de vÃ©rification KBS est : {{code}}. Valable {{expire_dans}}.',
 '["nom","code","expire_dans"]'),

(1, 'EMAIL_BIENVENUE', 'PARCELLES',
 'Bienvenue chez KITUMAINI BALEZI Serge',
 'Bienvenue {{nom}} {{prenom}} ! Votre compte KBS est activÃ©.',
 '["nom","prenom"]'),

(1, 'EMAIL_RESERVATION_CLIENT', 'PARCELLES',
 'Votre rÃ©servation {{reference}} â€” KBS Immobilier',
 'RÃ©servation {{reference}} confirmÃ©e pour la parcelle {{parcelle}}.',
 '["nom","parcelle","date","reference"]'),

(1, 'EMAIL_RESERVATION_ADMIN', 'PARCELLES',
 'Nouvelle rÃ©servation reÃ§ue â€” {{reference}}',
 'Nouvelle rÃ©servation {{reference}} de {{client}} sur {{parcelle}}.',
 '["client","parcelle","date","reference"]'),

(1, 'EMAIL_VENTE_CONFIRMEE', 'PARCELLES',
 'Vente confirmÃ©e â€” {{reference}} â€” KBS Immobilier',
 'FÃ©licitations {{nom}} ! Votre achat {{reference}} est confirmÃ©.',
 '["nom","parcelle","reference","date"]'),

(1, 'EMAIL_COMPTE_LOCATAIRE', 'KBS',
 'Votre espace locataire KBS Buildings',
 'Bonjour {{nom}}, votre compte locataire KBS a Ã©tÃ© crÃ©Ã©.',
 '["nom","email","mot_de_passe_temp"]'),

(1, 'PUSH_ECHEANCE_J7', 'KBS',
 'Rappel : Ã‰chÃ©ance de loyer dans 7 jours â€” KBS Buildings',
 'Bonjour {{nom}}, votre Ã©chÃ©ance de loyer arrive dans 7 jours ({{date_fin}}). Montant : {{montant}} {{devise}}. â€” KBS Buildings',
 '["nom","date_fin","montant","devise"]'),

(1, 'EMAIL_FACTURE_VALIDEE', 'KBS',
 'Votre facture {{reference}} est disponible â€” KBS Buildings',
 'Votre facture {{reference}} ({{periode}}) est validÃ©e et disponible au tÃ©lÃ©chargement.',
 '["nom","reference","periode","montant"]'),

(1, 'EMAIL_FACTURE_REJETEE', 'KBS',
 'Votre facture {{reference}} a Ã©tÃ© rejetÃ©e â€” KBS Buildings',
 'Votre facture {{reference}} a Ã©tÃ© rejetÃ©e. Motif : {{motif}}.',
 '["nom","reference","motif"]');

-- ============================================================
-- FIN DE LA BASE DE DONNÃ‰ES KBS
-- KITUMAINI BALEZI Serge
-- ============================================================
